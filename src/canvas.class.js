(function () {
  ...
  fabric.Canvas = fabric.util.createClass(
    ...
    /** @lends fabric.Canvas.prototype */ {
      ...
      /**
       * Returns an array with the current selected objects, exclude Workspace and GuideLine
       * @return {fabric.Object} active object
       */
      getActiveObjects: function () {
        ...
        if (active) {
          if (active.type === 'activeSelection' && active._objects) {
            var objects = active._objects.slice(0);
            return objects.filter(function (obj) {
              return obj.type !== 'Workspace' && obj.type !== 'Guideline';
            });
          }
          else {
            if (active.type !== 'Workspace' && active.type !== 'Guideline') {
              return [active];
            }
          }
        }
